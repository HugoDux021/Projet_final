pipeline {
      ...
      post {
          always {
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'pipelineprojet/output.txt', reportFiles: 'index.html', reportName: 'Flake 8 violations', reportTitles: ''])
            recordIssues(
